...
const TeacherDetails = () => {
  ...
  const teacher = {
    photoUrl: "/Assets/images/TeachersImages/teacher.webp",
    name: "Steven Johnson",
    gender: "Male",
  ...
  return (
    <>
    <div className="teacherdetails-main-container">
    <Breadcrumb heading="Teacher" route="Home > Teacher Details" /> 
    <div className="container-teacher-details">  
